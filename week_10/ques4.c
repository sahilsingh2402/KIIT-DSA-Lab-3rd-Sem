...
int main()
{
    ...
    do
    {
        ...
        case 1:
            ...
            int pri_535;
            scanf("%d", &pri_535);
            enqueue_535(&que_535, val_535, pri_535);
...
void enqueue_535(Queue_535 *que_535, int num, int priority_535)
{
    Node_535 *temp_535 = (Node_535 *)malloc(sizeof(Node_535));
    temp_535->data_535 = num;
    temp_535->priority_535 = priority_535;
    ...
    Node_535 *tempPrev_535 = NULL;
    Node_535 *tempFront_535 = que_535->front_535;
    while (tempFront_535 && priority_535 <= tempFront_535->priority_535)
    {
        tempPrev_535 = tempFront_535;
        tempFront_535 = tempFront_535->link_535;
    }
    if (!tempPrev_535)
    {
        temp_535->link_535 = que_535->front_535;
        que_535->front_535 = temp_535;
        return;
    }
    temp_535->link_535 = tempFront_535;
    tempPrev_535->link_535 = temp_535;
}
...
void show_queue_535(Queue_535 *que_535)
{
    ...
    while (!isEmpty_535(que_535))
    {
        ...
        int pri_535 = que_535->front_535->priority_535;
        enqueue_535(&temp_535, dequeue_535(que_535), pri_535);
    }
    printf("\b\b \n");
